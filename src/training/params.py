...
def get_default_params(model_name):
    ...
    if "vit" in model_name:
        return {"lr": 1e-7, "beta1": 0.9, "beta2": 0.98, "eps": 1.0e-6}
    else:
        # return {"lr": 5.0e-4, "beta1": 0.9, "beta2": 0.999, "eps": 1.0e-8}
        return {"lr": 1e-7, "beta1": 0.9, "beta2": 0.999, "eps": 1.0e-8}
...
def parse_args():
    ...
    parser.add_argument( "--kg-init",  default='random',   help="wikidata,wikipedia,random")
    ...
    parser.add_argument(
        ...
        default="auto",
        help="Which type of dataset to process. auto"
    )
    parser.add_argument(
        "--dataset-resampled",
        default=False,
    ...
    parser.add_argument(
        "--batch-size", type=int, default=2, help="Batch size per GPU. 256"
    )
    parser.add_argument(
    ...
    parser.add_argument("--wd", type=float, default=0.001, help="Weight decay.")  # default=0.2
    parser.add_argument(
        "--warmup", type=int, default=10, help="Number of steps to warmup for."
    )
    parser.add_argument(
        "--use-bn-sync",
        default=False,
    ...
    parser.add_argument(
        "--resume",
        default=None,
        # default= "/nfs/home/tahmasebzadehg/clipz/sbatch/logs/2023_05_02_coop_freeze_gat-init-random-model-ViT-B-32-ctx-4-end-shot-1/checkpoints/epoch_200.pt",
        type=str,
    ...
    parser.add_argument(
        "--model",
        type=str,
        default="ViT-B-32", #ViT-B-32, RN50
